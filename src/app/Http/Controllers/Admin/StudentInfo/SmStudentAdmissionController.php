...
class SmStudentAdmissionController extends Controller
{
    ...
    public function updateStudentInfo($request)
    {
        ...
        try {
            ...
            $user_stu = $this->add_user($student_detail->user_id, 2, $username, $request->email_address, $phone_number);
            ...
            if (($request->sibling_id == 0 || $request->sibling_id == 1) && $request->parent_id == "") {
                ...
                if ($request->guardians_phone || $request->guardians_email) {
                    $user_parent = $this->add_user($parentUserId, 3, $username, $request->guardians_email, $phone_number);
                ...
                $phone_number = $request->guardians_phone;
                if ($request->guardians_phone || $request->guardians_email) {
                    $user_parent = $this->add_user(null, 3, $username, $request->guardians_email, $phone_number);
    ...
    private function add_user($user_id, $role_id, $username, $email, $phone_number)
    {
        try {
