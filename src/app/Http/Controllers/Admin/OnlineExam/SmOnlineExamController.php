...
class SmOnlineExamController extends Controller
{
    ...
    public function onlineExamPublish($id)
    {
        ...
        try{
            ...
            ->pluck('student_id')
            ->unique();
            $students = SmStudent::whereIn('id', $student_ids)->where('class_id', $class_id)->where('section_id', $section_id)->where('academic_id', getAcademicId())->where('school_id', Auth::user()->school_id)->get();
