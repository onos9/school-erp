...
<body class="admin">
    ...
    <div class="container">
        <div class="col-md-8 offset-2  mt-40">
            <ul id="progressbar">
                <li
                    class="{{ active_progress_bar(['service.install', 'service.preRequisite', 'service.license', 'service.database', 'service.user', 'service.done']) }}">
                    {{ __('service::install.welcome') }}</li>
                <li
                    class="{{ active_progress_bar(['service.preRequisite', 'service.license', 'service.database', 'service.user', 'service.done']) }} {{ active_link('service.license') }}">
                    {{ __('service::install.environment') }}</li>
                <li
                    class="{{ active_progress_bar(['service.license', 'service.database', 'service.user', 'service.done']) }}">
                    {{ __('service::install.license') }}</li>
                <li class="{{ active_progress_bar(['service.database', 'service.user', 'service.done']) }}">
                    {{ __('service::install.database') }}</li>
                <li class="{{ active_progress_bar(['service.user', 'service.done']) }}">
                    {{ __('service::install.admin_setup') }}</li>
