                                        ...
                                        <table class="display school-table school-table-style width-shadow">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ config('configs')->where('key', 'system_domain')->first()->value }}
                                                    </td>
                                                </tr>

                                                <tr>
                                                    <td>{{ __('setting.System Activated Date') }}</td>
                                                    <td>{{ config('configs')->where('key', 'system_activated_date')->first()->value }}
                                                    </td>
                                                </tr>
                            ...
                            <div class="col-md-12">
                                @if (gv($product, 'name'))
                                    ...
                                    <div class="text-center">
                                        ...
                                        <button type="button" class="primary-btn fix-gr-bg" data-toggle="modal"
                                            data-target="#update_modal" data-modal-size="modal-md">Update</button>
                        ...
                        <form method="POST" action="{{ route('service.download') }}" id="content_form"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12" id="download_buttons">
                                    <p class="text-center">Are You sure to update <br> version
                                        {{ gv($product, 'next_release_version') }} <br>
                                ...
                                <div class="col-lg-12 text-center">
                                    <div class="mt-40 d-flex justify-content-between">
                                        ...
                                        <button type="button" class="primary-btn fix-gr-bg submitting"
                                            style="display: none; " disabled="">Updating...</button>
