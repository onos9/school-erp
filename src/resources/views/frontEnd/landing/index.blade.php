...
<head>
    ...
    <script type="application/ld+json">
        [{
            ...
            "screenshot": "http://infixedu.com/landing/img/dashboard_preview.png",
            "softwareVersion": "2.0",
    ...
    <meta property="og:image" content="http://infixedu.com/landing/img/dashboard_preview.png" />


    <!-- Open Graph data -->
    <meta property="og:type" content="website" />
    <meta property="og:url" content="//infixedu.com/" />
    <meta property="og:image" content="//infixedu.com/landing/img/dashboard_preview.png" />
                        ...
                        <div class="banner_text_iner">
                            ...
                            @if (!moduleStatusCheck('Saas'))
                                <a class="btn_1" target="_blank"
                                    href="mailto:support@spondonit.com?subject=Request for saas school demo!&body=This is only a test!">
                ...
                <div class="col-lg-12">
                    <nav class="navbar navbar-expand-lg navbar-light">
                        ...
                        <a class="btn_1 d-none d-lg-block" target="_blank"
                            href="https://codecanyon.net/item/infix-school-academic-management-system/23876323">Purchase</a>
                    </nav>
                </div>
            </div>
        </div>
            ...
            <div class="row align-items-center">
                <div class="col-md-7 col-lg-7">
                    <div class="video_section_img">
                        ...
                        <!-- <img src="{{ asset('landing/img/vodeo_bg.png') }}" alt=""> -->
                ...
                <div class="col-md-5 col-lg-5">
                    <div class="video_section_text">
                        ...
                        <img src="{{ asset('landing/img/Line.png') }}" alt="">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="dashboard_img">
                        ...
                        <img src="{{ asset('landing/img/dashboard_preview.png') }}" alt="">
                    </div>
                </div>
                <div class="col-sm-6 col-xl-3">
                    <div class="single_feature">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="footer_area_text">
                        ...
                        <a href="https://codecanyon.net/item/infix-school-academic-management-system/23876323"
                            class="footer_btn"> <i class="ti-shopping-cart-full"></i>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="copyright_text">
                        <p> <img src="{{ asset('landing/img/copyright.svg') }}" alt="#"> 2019-2020 InfixEdu -
                            Ultimate Education ERP. All Rights
