                        ...
                        <div role="tabpanel" class="tab-pane fade  @if($key== 0) active show @endif" id="tab{{$key}}">
                           <div class="row mt-40">
                                <div class="col-lg-12 mb-40">
                                    <a href="{{route('my-attendance/print', [$record->id,$month, $year])}}" class="primary-btn small fix-gr-bg pull-right" target="_blank"><i class="ti-printer"> </i> @lang('common.print')</a>
                                </div>
                                <div class="col-lg-12">
