                        ...
                        <div class="col-12">
                            <div class="main-title d-flex align-items-center flex-wrap mb_sm_75">
                                ...
                                <div class="fes_lag_btn d-flex align-items-center">
                                    <button name="send_email" type="submit" class="primary-btn small fix-gr-bg mr-2 d-none">
                                        <span class="ti-envelope pr-2"></span>
                                        @lang('communicate.send_email')
                                    </button>
                                    <button name="send_sms" type="submit" class="primary-btn small fix-gr-bg d-none">
                                        <span class="ti-envelope pr-2"></span>
