            ...
            <tr>
                ...
                <td style="text-aligh:left">
                    ...
                    <span style="font-size:11px !important;margin-right:10px;" align="left"
                        class="text-white">@lang('common.class_Sec'): {{ @$class->class_name . '(' . $section->section_name . ')' }}
                    </span>
                ...
                <td style="text-aligh:center">
                    ...
                    <span style="font-size:11px !important;margin:0px" class="text-white ">
                        {{ isset(generalSetting()->address) ? generalSetting()->address : 'Infix School Address' }} </span>
