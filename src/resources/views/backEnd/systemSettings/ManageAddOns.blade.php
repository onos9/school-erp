                                                                            ...
                                                                            <div class="modal-content">
                                                                                ...
                                                                                <div class="modal-body text-left">
                                                                                    ...
                                                                                    <div class="form-group">
                                                                                        <label for="envatouser">Envato Email
                                                                                            :</label>
                                                                                        <input type="email"
                                                                                            class="form-control"
                                                                                            name="envatouser"
                                                                                    ...
                                                                                    <div class="form-group">
                                                                                        <label for="purchasecode">Purchase
                                                                                            Code:</label>
                                                                                        <input type="text"
                                                                                            class="form-control"
                                    ...
                                    <div class="row no-gutters input-right-icon mb-20">
                                        <div class="col">
                                            <div class="input-effect">
                                                <input
                                                    class="primary-input form-control {{ $errors->has('module_file') ? ' is-invalid' : '' }}"
