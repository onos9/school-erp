        ...
        <div class="row">
            ...
            @foreach ($all_modules as $module_info)
                @php
                    ...
                    $all_group_modules = Modules\RolePermission\Entities\InfixModuleStudentParentInfo::where('module_id', $module_info->id)
                        ->where('id', '!=', $module_info->id)->where('active_status', 1)
                        ->get();
                    ...
                    <div class="single_permission" id="{{ $module_info->id }}">
                        ...
                        <div class="permission_body">
                            <ul>
                                ...
                                $subModule = DB::table('infix_module_student_parent_infos')
                                ...
                                @foreach ($subModule as $row2)
                                    <li>
                                        ...
                                        <ul class="option">
                                            ...
                                            $childModule = DB::table('infix_module_student_parent_infos')
